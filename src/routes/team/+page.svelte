...
<div class="main--content">
    ...
    <div class="section--teams">
        ...
        {#each teams as team, idx}
            <Team idx={idx} name={team.name} headline={team.headline} image={team.image} description={team.description} id={team.id} tags={team.tags} />
        {/each}
    </div>
</div>
